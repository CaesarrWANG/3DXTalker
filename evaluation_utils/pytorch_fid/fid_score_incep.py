...
from evaluation_utils.pytorch_fid.inception import InceptionV3
...
def calculate_activation_statistics(
    ...
    -- sigma : The covariance matrix of the activations of the pool_3 layer of
               the inception model.
    """
    act = get_activations(files[:250], model, batch_size, dims, device, num_workers)
...
if __name__ == "__main__":
    ...
    for dataset in dataset_list:
        ...
        for sample in samples_list:
            ...
            fid_score = calculate_fid_given_paths(paths=[gt_frames_folder, pred_frames_folder], batch_size=128, device="cuda:0", dims=768, num_workers=8) # [64, 192, 768, 2048]
            print(f"~~~~~~~~~~~~~~~~~~~~~FID: {fid_score}~~~~~~~~~~~~~~~~~~~~")
            fid_lst.append(fid_score.item())
    print("==== Final Evaluation Results ====")
    print(f"Emo-FID: {np.mean(fid_lst)}")
